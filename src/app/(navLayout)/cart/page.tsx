...
export default function Cart() {
    ...
    return (
            <div className="w-full max-w-[1000px] px-6">
                ...
                <form action={orderAction} className="flex gap-4">
                    ...
                    <div className="px-4 w-60 flex flex-col gap-1">
                        ...
                        <button className="bg-purewhite text-main hover:bg-zinc-300 w-full py-2 mt-2 font-bold">주문하기</button>
                    </div>
                </form>
            </div>
        );
